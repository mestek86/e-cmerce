...
public class C10_WishlistStepDefinitions {
    ...
    public void add_a_product_to_the_Wishlist() {
        // Add product_1 to Wishlist & Assert its existence//
    ...
    public void add_another_product_to_the_Wishlist() {
        // Add product_2 to Wishlist & Assert its existence //
    ...
    {
        // Go to Wishlist page & Check Wishlist products table //
